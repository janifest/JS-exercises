...
let dreamDestination = "Philippines";
...
// The crucial difference between the rules for num1 and num2 is the "equal to" option for num2. num1 exludes equality to either
// 1 or 10 while num2 allows for this equality.

// Exercise 7. Now we will try some addition.
// a. Assign the the values of 4 and 6 to num1 and num2, respectively.

num1 = 4;
num2 = 6;   // both num1 and num2 have been declared already
...
const myAnswerForExercise22 = "true"; // false < 3 === true

// Congrats, you made it to the end!
// Did you find this easy or hard? If you used references, which ones helped you?
// Please answer in a comment below.
//  I found this assignment easy, but also important to look over and solidify in my learning process. 
//  I went over the conventional order of operations for Javascript here: 
//  https://www.sitepoint.com/javascript-operators-conditionals-functions/
//  As well as multiple comparison operators (this is new to me):
//  https://stackoverflow.com/questions/40553814/multiple-comparison-operators
//  I reviewed type coercion here:
//  https://www.freecodecamp.org/news/js-type-coercion-explained-27ba3d9a2839/
//  I also tested the mulitplication and division of different data types on my private replit (e.g. a string and number)
